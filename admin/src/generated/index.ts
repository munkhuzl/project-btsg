...
export type ChangeReStatusMutationVariables = Exact<{
  result: Scalars['String']['input'];
  id: Scalars['ID']['input'];
  comment?: InputMaybe<Scalars['String']['input']>;
}>;
...
export type ChangeReStatusMutation = { __typename?: 'Mutation', changeReStatus: { __typename?: 'StatusChangedResponse', message?: string | null } };
...
export type CreateRequestTypeMutationVariables = Exact<{
  input: CreateRequestTypeInput;
}>;


export type CreateRequestTypeMutation = { __typename?: 'Mutation', createRequestType: { __typename?: 'RequestTypeTemplate', _id: string, name: string, description?: string | null, fields: Array<{ __typename?: 'RequestFieldDefinition', id: string, label: string, type: string, required: boolean }> } };

export type DeleteRequestTypeMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;
...
export const ChangeReStatusDocument = gql`
    mutation ChangeReStatus($result: String!, $id: ID!, $comment: String) {
  changeReStatus(result: $result, _id: $id, comment: $comment) {
    message
  }
}
    `;
export type ChangeReStatusMutationFn = Apollo.MutationFunction<ChangeReStatusMutation, ChangeReStatusMutationVariables>;
export type ChangeReStatusProps<TChildProps = {}, TDataName extends string = 'mutate'> = {
      [key in TDataName]: Apollo.MutationFunction<ChangeReStatusMutation, ChangeReStatusMutationVariables>
    } & TChildProps;
export function withChangeReStatus<TProps, TChildProps = {}, TDataName extends string = 'mutate'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  ChangeReStatusMutation,
  ChangeReStatusMutationVariables,
  ChangeReStatusProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withMutation<TProps, ChangeReStatusMutation, ChangeReStatusMutationVariables, ChangeReStatusProps<TChildProps, TDataName>>(ChangeReStatusDocument, {
      alias: 'changeReStatus',
      ...operationOptions
    });
};

/**
 * __useChangeReStatusMutation__
 *
 * To run a mutation, you first call `useChangeReStatusMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useChangeReStatusMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [changeReStatusMutation, { data, loading, error }] = useChangeReStatusMutation({
 *   variables: {
 ...
 * });
 */
export function useChangeReStatusMutation(baseOptions?: Apollo.MutationHookOptions<ChangeReStatusMutation, ChangeReStatusMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ChangeReStatusMutation, ChangeReStatusMutationVariables>(ChangeReStatusDocument, options);
      }
export type ChangeReStatusMutationHookResult = ReturnType<typeof useChangeReStatusMutation>;
export type ChangeReStatusMutationResult = Apollo.MutationResult<ChangeReStatusMutation>;
export type ChangeReStatusMutationOptions = Apollo.BaseMutationOptions<ChangeReStatusMutation, ChangeReStatusMutationVariables>;
...
export const CreateRequestTypeDocument = gql`
  ...
  createRequestType(input: $input) {
    ...
    `;
export type CreateRequestTypeMutationFn = Apollo.MutationFunction<CreateRequestTypeMutation, CreateRequestTypeMutationVariables>;
export type CreateRequestTypeProps<TChildProps = {}, TDataName extends string = 'mutate'> = {
      [key in TDataName]: Apollo.MutationFunction<CreateRequestTypeMutation, CreateRequestTypeMutationVariables>
    } & TChildProps;
export function withCreateRequestType<TProps, TChildProps = {}, TDataName extends string = 'mutate'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  CreateRequestTypeMutation,
  CreateRequestTypeMutationVariables,
  CreateRequestTypeProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withMutation<TProps, CreateRequestTypeMutation, CreateRequestTypeMutationVariables, CreateRequestTypeProps<TChildProps, TDataName>>(CreateRequestTypeDocument, {
      alias: 'createRequestType',
      ...operationOptions
    });
};

/**
 * __useCreateRequestTypeMutation__
 *
 * To run a mutation, you first call `useCreateRequestTypeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateRequestTypeMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createRequestTypeMutation, { data, loading, error }] = useCreateRequestTypeMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateRequestTypeMutation(baseOptions?: Apollo.MutationHookOptions<CreateRequestTypeMutation, CreateRequestTypeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateRequestTypeMutation, CreateRequestTypeMutationVariables>(CreateRequestTypeDocument, options);
      }
export type CreateRequestTypeMutationHookResult = ReturnType<typeof useCreateRequestTypeMutation>;
export type CreateRequestTypeMutationResult = Apollo.MutationResult<CreateRequestTypeMutation>;
export type CreateRequestTypeMutationOptions = Apollo.BaseMutationOptions<CreateRequestTypeMutation, CreateRequestTypeMutationVariables>;
export const DeleteRequestTypeDocument = gql`
    mutation DeleteRequestType($id: ID!) {
  deleteRequestType(id: $id)
}
    `;
export type DeleteRequestTypeMutationFn = Apollo.MutationFunction<DeleteRequestTypeMutation, DeleteRequestTypeMutationVariables>;
export type DeleteRequestTypeProps<TChildProps = {}, TDataName extends string = 'mutate'> = {
      [key in TDataName]: Apollo.MutationFunction<DeleteRequestTypeMutation, DeleteRequestTypeMutationVariables>
    } & TChildProps;
export function withDeleteRequestType<TProps, TChildProps = {}, TDataName extends string = 'mutate'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  DeleteRequestTypeMutation,
  DeleteRequestTypeMutationVariables,
  DeleteRequestTypeProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withMutation<TProps, DeleteRequestTypeMutation, DeleteRequestTypeMutationVariables, DeleteRequestTypeProps<TChildProps, TDataName>>(DeleteRequestTypeDocument, {
...
/**
 * __useDeleteRequestTypeMutation__
 *
 * To run a mutation, you first call `useDeleteRequestTypeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteRequestTypeMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [deleteRequestTypeMutation, { data, loading, error }] = useDeleteRequestTypeMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useDeleteRequestTypeMutation(baseOptions?: Apollo.MutationHookOptions<DeleteRequestTypeMutation, DeleteRequestTypeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteRequestTypeMutation, DeleteRequestTypeMutationVariables>(DeleteRequestTypeDocument, options);
      }
