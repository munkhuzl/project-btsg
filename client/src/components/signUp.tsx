    ...
    return (
        <div className="flex min-h-[80vh] items-center justify-center px-4 py-12">
            <Card className="w-full max-w-[448px] rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm sm:p-10">
                ...
                <h1 className="mt-6 text-center text-[28px] font-semibold leading-9 text-zinc-950">Бүртгүүлэх</h1>
                        ...
                        <Form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-6">
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input id="email" placeholder="name@example.com" name="email" onChange={handleChange} value={values.email} className="h-12 rounded-xl border-zinc-200 bg-zinc-50 pl-11 pr-4 text-[16px] text-zinc-950 placeholder:text-zinc-400 focus-visible:border-zinc-950 focus-visible:ring-zinc-950/10" />
                                </div>
                            </div>
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input id="password" type={showPassword ? "text" : "password"} placeholder="••••••••" onChange={handleChange} value={values.password} className="h-12 rounded-xl border-zinc-200 bg-zinc-50 pl-11 pr-11 text-[16px] text-zinc-950 placeholder:text-zinc-400 focus-visible:border-zinc-950 focus-visible:ring-zinc-950/10" />
                            ...
                            <button type="button" onClick={() => router.push("/login")} className="text-center text-[14px] font-semibold text-zinc-950 hover:underline">
                                Нэвтрэх
                            </button>
                        </Form>
                    )}
